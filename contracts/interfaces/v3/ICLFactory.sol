...
interface ICLFactory {
     ...
     * @param oldFeeManager The swapFeeManager before the change
     * @param newFeeManager The swapFeeManager after the change
     */
     ...
     * @param oldFeeModule The swapFeeModule before the change
     * @param newFeeModule The swapFeeModule after the change
     */
     ...
     * @param oldFeeManager The unstakedFeeManager before the change
     * @param newFeeManager The unstakedFeeManager after the change
     */
     ...
     * @param oldFeeModule The unstakedFeeModule before the change
     * @param newFeeModule The unstakedFeeModule after the change
     */
     ...
     * @param oldUnstakedFee The defaultUnstakedFee before the change
     * @param newUnstakedFee The defaultUnstakedFee after the change
     */
    ...
    /**
     * @notice Returns the address of the pool implementation contract used to deploy proxies / clones
    ...
    /**
     * @notice Returns the pool address for a pool created by this factory given its index.
    ...
    /**
     * @notice Determines if a contract is a valid pool of the factory.
    ...
    /**
     * @notice Retrieves the swap & flash fee for a given pool.
    ...
    /**
     * @notice Retrieves the unstaked fee for a given pool.
     ...
     * @dev Reverts if the pool already exists, the tick spacing is invalid, or the token arguments are invalid.
    ...
    /**
     * @notice Updates the default unstaked fee of the factory.
     * @dev Must be called by the current unstaked fee manager.
     * @param _defaultUnstakedFee The new default unstaked fee of the factory.
     */
    function setDefaultUnstakedFee(uint24 _defaultUnstakedFee) external;

    /**
     * @notice Enables a new tick spacing for pool creation.
     * @dev Tick spacings may never be removed once enabled.
     * @param tickSpacing The tick spacing to enable.
     * @param fee The default fee associated with this tick spacing.
     */
